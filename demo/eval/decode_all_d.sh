...
CUDA_VISIBLE_DEVICES=$5 python ../../generate.py $DATA_BIN \
    --path $1/$2  \
    ...
    --remove-bpe \
    --gen-subset test$3  > ./raw/raw_$5.txt

grep ^H ./raw/raw_$5.txt | cut -f1,3- | cut -c3- | sort -k1n | cut -f2-   > ${1}/res_files/${2}.${3}
