...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python ../../generate.py $DATA_BIN \
    --path $1/$2  \
    ...
    --remove-bpe \
    --gen-subset test$3  > ./raw/raw_b.txt

grep ^H ./raw/raw_b.txt | cut -f1,3- | cut -c3- | sort -k1n | cut -f2-   > ${1}/res_files/${2}.${3}
