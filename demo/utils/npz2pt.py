...
def main():
    ...
    inputs=["/search/odin/haiyang/fairseq_exp/baseline/demo/cp/test/checkpoint40out.pt"]
    output="/search/odin/haiyang/fairseq_exp/baseline/demo/cp/test/checkpoint40out.pt"
    # if num is not None:
    #     args.inputs = last_n_checkpoints(
    #         inputs, num, is_update_based, upper_bound=args.checkpoint_upper_bound,
    #     )
